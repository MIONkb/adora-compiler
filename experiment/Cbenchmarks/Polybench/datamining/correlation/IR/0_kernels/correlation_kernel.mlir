    ...
    ADORA.kernel {
      affine.for %arg5 = 0 to 27 {
        ...
        affine.for %arg6 = 0 to #map(%arg5) {
          affine.store %cst_1, %arg2[%arg5, %arg5 + %arg6 + 1] : memref<?x28xf32>
          affine.for %arg7 = 0 to 32 {
            %1 = affine.load %arg1[%arg7, %arg5] : memref<?x28xf32>
            %2 = affine.load %arg1[%arg7, %arg5 + %arg6 + 1] : memref<?x28xf32>
            %3 = arith.mulf %1, %2 : f32
            %4 = affine.load %arg2[%arg5, %arg5 + %arg6 + 1] : memref<?x28xf32>
            %5 = arith.addf %4, %3 : f32
            affine.store %5, %arg2[%arg5, %arg5 + %arg6 + 1] : memref<?x28xf32>
          }
          %0 = affine.load %arg2[%arg5, %arg5 + %arg6 + 1] : memref<?x28xf32>
          affine.store %0, %arg2[%arg5 + %arg6 + 1, %arg5] : memref<?x28xf32>
        }
      }
      ADORA.terminator
