...
cgeist \
    -O3 \
    -lm -lgcc \
    -Dsize_t=int -Dwint_t=int -DROCKET_TARGET \
    -DLARGE_DATASET \
    -I/home/jhlou/CGRVOPT/cgra-opt/experiment/Cbenchmarks/Polybench/datamining/correlation \
    ...
    /home/jhlou/CGRVOPT/cgra-opt/experiment/Cbenchmarks/Polybench/datamining/correlation/correlation.c \
    -S -o correlation.mlir
