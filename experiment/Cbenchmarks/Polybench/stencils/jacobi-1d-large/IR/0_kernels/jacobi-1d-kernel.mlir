  ...
  func.func @jacobi_1d(%arg0: memref<2000xf32>, %arg1: memref<2000xf32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg2 = 0 to 500 {
      ...
      affine.for %arg3 = 0 to 1998 {
        ...
        %1 = affine.load %arg0[%0 - 1] : memref<2000xf32>
        %2 = affine.load %arg0[%0] : memref<2000xf32>
        %3 = arith.addf %1, %2 : f32
        %4 = affine.load %arg0[%0 + 1] : memref<2000xf32>
        %5 = arith.addf %3, %4 : f32
        %6 = arith.mulf %5, %cst : f32
        affine.store %6, %arg1[%0] : memref<2000xf32>
      }
      ADORA.terminator}     {KernelName = "kernel_jacobi_1d_0"}
       
      ADORA.kernel{
      affine.for %arg3 = 0 to 1998 {
        %0 = affine.apply #map(%arg3)
        %1 = affine.load %arg1[%0 - 1] : memref<2000xf32>
        %2 = affine.load %arg1[%0] : memref<2000xf32>
        %3 = arith.addf %1, %2 : f32
        %4 = affine.load %arg1[%0 + 1] : memref<2000xf32>
        %5 = arith.addf %3, %4 : f32
        %6 = arith.mulf %5, %cst : f32
        affine.store %6, %arg0[%0] : memref<2000xf32>
      }
      ADORA.terminator}     {KernelName = "kernel_jacobi_1d_1"}
    }
    return
  }
}
