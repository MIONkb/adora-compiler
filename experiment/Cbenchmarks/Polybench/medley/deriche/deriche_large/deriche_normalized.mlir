module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @kernel_deriche(%arg0: memref<4096x2160xf32>, %arg1: memref<4096x2160xf32>, %arg2: memref<4096x2160xf32>, %arg3: memref<4096x2160xf32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg4 = 0 to 4096 {
      ...
      affine.for %arg5 = 0 to 2160 {
        %1 = affine.load %arg0[%arg4, %arg5] : memref<4096x2160xf32>
        ...
        affine.store %11, %arg2[%arg4, %arg5] : memref<4096x2160xf32>
        %12 = affine.load %arg0[%arg4, %arg5] : memref<4096x2160xf32>
        affine.store %12, %alloca_14[] : memref<f32>
        affine.store %6, %alloca_11[] : memref<f32>
        %13 = affine.load %arg2[%arg4, %arg5] : memref<4096x2160xf32>
    ...
    affine.for %arg4 = 0 to 4096 {
      ...
      affine.for %arg5 = 0 to 2160 {
        ...
        %10 = arith.mulf %9, %cst_4 : f32
        %11 = arith.addf %8, %10 : f32
        affine.store %11, %arg3[%arg4, -%arg5 + 2159] : memref<4096x2160xf32>
        affine.store %1, %alloca_9[] : memref<f32>
        %12 = affine.load %arg0[%arg4, -%arg5 + 2159] : memref<4096x2160xf32>
        affine.store %12, %alloca_10[] : memref<f32>
        affine.store %6, %alloca[] : memref<f32>
        %13 = affine.load %arg3[%arg4, -%arg5 + 2159] : memref<4096x2160xf32>
        affine.store %13, %alloca_6[] : memref<f32>
      }
    }
    affine.for %arg4 = 0 to 4096 {
      affine.for %arg5 = 0 to 2160 {
        %1 = affine.load %arg2[%arg4, %arg5] : memref<4096x2160xf32>
        %2 = affine.load %arg3[%arg4, %arg5] : memref<4096x2160xf32>
        %3 = arith.addf %1, %2 : f32
        affine.store %3, %arg1[%arg4, %arg5] : memref<4096x2160xf32>
      }
    }
    affine.for %arg4 = 0 to 2160 {
      ...
      affine.for %arg5 = 0 to 4096 {
        %1 = affine.load %arg1[%arg5, %arg4] : memref<4096x2160xf32>
        %2 = arith.mulf %1, %cst_2 : f32
        ...
        %10 = arith.mulf %9, %cst_4 : f32
        %11 = arith.addf %8, %10 : f32
        affine.store %11, %arg2[%arg5, %arg4] : memref<4096x2160xf32>
        %12 = affine.load %arg1[%arg5, %arg4] : memref<4096x2160xf32>
        affine.store %12, %alloca_13[] : memref<f32>
        affine.store %6, %alloca_11[] : memref<f32>
        %13 = affine.load %arg2[%arg5, %arg4] : memref<4096x2160xf32>
        affine.store %13, %alloca_12[] : memref<f32>
      }
    }
    affine.for %arg4 = 0 to 2160 {
      ...
      affine.for %arg5 = 0 to 4096 {
        ...
        %10 = arith.mulf %9, %cst_4 : f32
        %11 = arith.addf %8, %10 : f32
        affine.store %11, %arg3[-%arg5 + 4095, %arg4] : memref<4096x2160xf32>
        affine.store %1, %alloca_7[] : memref<f32>
        %12 = affine.load %arg1[-%arg5 + 4095, %arg4] : memref<4096x2160xf32>
        affine.store %12, %alloca_8[] : memref<f32>
        affine.store %6, %alloca[] : memref<f32>
        %13 = affine.load %arg3[-%arg5 + 4095, %arg4] : memref<4096x2160xf32>
        affine.store %13, %alloca_6[] : memref<f32>
      }
    }
    affine.for %arg4 = 0 to 4096 {
