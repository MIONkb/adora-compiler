...
module {
  func.func @deriche_kernel_3(%arg0: memref<f32>, %arg1: memref<f32>, %arg2: memref<f32>, %arg3: memref<4096x2160xf32>, %arg4: memref<4096x2160xf32>) attributes {Kernel, deriche_kernel_3} {
    cf.br ^bb1
  ^bb1:  // pred: ^bb0
    ...
    affine.for %arg5 = 0 to 4096 {
      ...
      affine.for %arg6 = 0 to 2160 step 1080 {
        ...
        %6 = ADORA.LocalMemAlloc memref<1x1080xf32>  {Id = "9", KernelName = ""}
        ...
        ADORA.kernel {
          affine.for %arg7 = 0 to 1080 {
            %7 = affine.load %3[0, %arg7] : memref<1x1080xf32>
            %8 = arith.mulf %7, %cst_0 : f32
            %9 = affine.load %0[0] : memref<2xf32>
            %10 = arith.mulf %9, %cst_1 : f32
            %11 = arith.addf %8, %10 : f32
            %12 = affine.load %2[0] : memref<2xf32>
            %13 = arith.mulf %12, %cst_2 : f32
            %14 = arith.addf %11, %13 : f32
            %15 = affine.load %1[0] : memref<2xf32>
            %16 = arith.mulf %15, %cst_3 : f32
            %17 = arith.addf %14, %16 : f32
            affine.store %17, %6[0, %arg7] : memref<1x1080xf32>
            %18 = affine.load %4[0, %arg7] : memref<1x1080xf32>
            affine.store %18, %a0[0] : memref<2xf32>
            affine.store %12, %a1[0] : memref<2xf32>
            %19 = affine.load %5[0, %arg7] : memref<1x1080xf32>
            affine.store %19, %a2[0] : memref<2xf32>
          }
          ADORA.terminator
        }
