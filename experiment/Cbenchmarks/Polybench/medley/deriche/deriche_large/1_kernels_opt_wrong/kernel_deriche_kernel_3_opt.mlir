    ...
    affine.for %arg5 = 0 to 4096 {
      ...
      affine.for %arg6 = 0 to 2160 step 1080 {
        ...
        ADORA.kernel {
          ...
          %10:3 = affine.for %arg7 = #map(%arg6) to #map1(%arg6) iter_args(%arg8 = %7, %arg9 = %8, %arg10 = %9) -> (f32, f32, f32) {
            %11 = affine.load %3[0, %arg7] : memref<1x1080xf32>
            %12 = arith.mulf %11, %cst_0 : f32
            %13 = arith.mulf %arg8, %cst_1 : f32
            %14 = arith.addf %12, %13 : f32
            %15 = arith.mulf %arg9, %cst_2 : f32
            %16 = arith.addf %14, %15 : f32
            %17 = arith.mulf %arg10, %cst_3 : f32
            %18 = arith.addf %16, %17 : f32
            affine.store %18, %6[0, %arg7] : memref<1x1080xf32>
            %19 = affine.load %4[0, %arg7] : memref<1x1080xf32>
            %20 = affine.load %5[0, %arg7] : memref<1x1080xf32>
            affine.yield %19, %20, %arg9 : f32, f32, f32
          }
          affine.store %10#2, %1[0] : memref<2xf32>
          affine.store %10#1, %2[0] : memref<2xf32>
          affine.store %10#0, %0[0] : memref<2xf32>
          ADORA.terminator
        }
