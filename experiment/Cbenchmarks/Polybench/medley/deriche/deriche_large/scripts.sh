...
cgeist \
    ...
    -DLARGE_DATASET \
    --import-all-index \
    -I/home/jhlou/CGRVOPT/cgra-opt/experiment/Cbenchmarks/Polybench/medley/deriche/ \
   ...
   /home/jhlou/CGRVOPT/cgra-opt/experiment/Cbenchmarks/Polybench/medley/deriche/deriche.c \
    -S -o deriche.mlir
...
cgra-opt \
    ...
    deriche_normalized.mlir -o deriche_host.mlir
