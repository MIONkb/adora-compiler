...
^bb1:  // pred: ^bb0
  ...
  affine.for %arg5 = 0 to 4096 {
    ...
    affine.for %arg6 = 0 to 2160 {
      %0 = affine.load %arg3[%arg5, %arg6] : memref<4096x2160xf32>
      ...
      affine.store %10, %arg4[%arg5, %arg6] : memref<4096x2160xf32>
      // %11 = affine.load %arg3[%arg5, %arg6] : memref<4096x2160xf32>
      affine.store %0, %arg2[] : memref<f32>
      affine.store %5, %arg1[] : memref<f32>
      // %12 = affine.load %arg4[%arg5, %arg6] : memref<4096x2160xf32>
