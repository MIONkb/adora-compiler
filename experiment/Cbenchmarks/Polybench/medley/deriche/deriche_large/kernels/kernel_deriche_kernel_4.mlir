...
^bb1:  // pred: ^bb0
  ...
  affine.for %arg7 = 0 to 4096 {
    ...
    affine.for %arg6 = 0 to 2160 {
      ...
      %5 = affine.load %arg2[] : memref<f32>
      %6 = arith.mulf %5, %cst_2 : f32
      %7 = arith.addf %4, %6 : f32
      %8 = affine.load %arg3[] : memref<f32>
      %9 = arith.mulf %8, %cst_3 : f32
      %10 = arith.addf %7, %9 : f32
      affine.store %10, %arg4[-%arg7 + 4095, %arg6] : memref<4096x2160xf32>
      affine.store %0, %arg1[] : memref<f32>
      %11 = affine.load %arg5[-%arg7 + 4095, %arg6] : memref<4096x2160xf32>
      affine.store %11, %arg0[] : memref<f32>
      affine.store %5, %arg3[] : memref<f32>
      %12 = affine.load %arg4[-%arg7 + 4095, %arg6] : memref<4096x2160xf32>
      affine.store %12, %arg2[] : memref<f32>
    }
    ADORA.terminator}
  }
  return
