...
func.func private @cholesky_kernel_1(memref<120x120xf32>, index)

// -----// IR Dump After PromoteBuffersToStack (promote-buffers-to-stack) //----- //
func.func private @cholesky_kernel_0(memref<120x120xf32>, index, index)
...
func.func @cholesky(%arg0: memref<120x120xf32>) attributes {llvm.linkage = #llvm.linkage<external>} {
  affine.for %arg1 = 0 to 120 {
    affine.for %arg2 = 0 to affine_map<(d0) -> (d0)>(%arg1) {
      func.call @cholesky_kernel_0(%arg0, %arg1, %arg2) : (memref<120x120xf32>, index, index) -> ()
    ...
    func.call @cholesky_kernel_1(%arg0, %arg1) : (memref<120x120xf32>, index) -> ()
  ...
  func.func @cholesky(%arg0: memref<120x120xf32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    scf.for %arg1 = %c0 to %c120 step %c1 {
      ...
      scf.for %arg2 = %c0_0 to %arg1 step %c1_1 {
        func.call @cholesky_kernel_0(%arg0, %arg1, %arg2) : (memref<120x120xf32>, index, index) -> ()
        %2 = memref.load %arg0[%arg2, %arg2] : memref<120x120xf32>
        %3 = memref.load %arg0[%arg1, %arg2] : memref<120x120xf32>
        %4 = arith.divf %3, %2 : f32
        memref.store %4, %arg0[%arg1, %arg2] : memref<120x120xf32>
      }
      func.call @cholesky_kernel_1(%arg0, %arg1) : (memref<120x120xf32>, index) -> ()
      %0 = memref.load %arg0[%arg1, %arg1] : memref<120x120xf32>
      %1 = math.sqrt %0 : f32
      memref.store %1, %arg0[%arg1, %arg1] : memref<120x120xf32>
    }
    return
  }
  func.func private @cholesky_kernel_0(memref<120x120xf32>, index, index)
...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  ^bb4:  // pred: ^bb3
    call @cholesky_kernel_0(%arg0, %0, %2) : (memref<120x120xf32>, index, index) -> ()
    %4 = memref.load %arg0[%2, %2] : memref<120x120xf32>
    %5 = memref.load %arg0[%0, %2] : memref<120x120xf32>
    %6 = arith.divf %5, %4 : f32
    memref.store %6, %arg0[%0, %2] : memref<120x120xf32>
    %7 = arith.addi %2, %c1 : index
    cf.br ^bb3(%7 : index)
  ^bb5:  // pred: ^bb3
    call @cholesky_kernel_1(%arg0, %0) : (memref<120x120xf32>, index) -> ()
    %8 = memref.load %arg0[%0, %0] : memref<120x120xf32>
    %9 = math.sqrt %8 : f32
    memref.store %9, %arg0[%0, %0] : memref<120x120xf32>
...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @cholesky(%arg0: memref<120x120xf32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %2 = llvm.mlir.constant(120 : index) : i64
  ...
  ^bb4:  // pred: ^bb3
    call @cholesky_kernel_0(%arg0, %4, %7) : (memref<120x120xf32>, index, index) -> ()
    %10 = memref.load %arg0[%7, %7] : memref<120x120xf32>
    %11 = memref.load %arg0[%4, %7] : memref<120x120xf32>
    %12 = llvm.fdiv %11, %10  : f32
    memref.store %12, %arg0[%4, %7] : memref<120x120xf32>
    %13 = llvm.add %8, %3  : i64
    %14 = builtin.unrealized_conversion_cast %13 : i64 to index
    cf.br ^bb3(%14 : index)
  ^bb5:  // pred: ^bb3
    call @cholesky_kernel_1(%arg0, %4) : (memref<120x120xf32>, index) -> ()
    %15 = memref.load %arg0[%4, %4] : memref<120x120xf32>
    %16 = llvm.intr.sqrt(%15)  : (f32) -> f32
    memref.store %16, %arg0[%4, %4] : memref<120x120xf32>
    %17 = llvm.add %5, %3  : i64
...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @cholesky(%arg0: memref<120x120xf32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    %0 = builtin.unrealized_conversion_cast %arg0 : memref<120x120xf32> to !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>
    %1 = llvm.mlir.constant(0 : index) : i64
    %2 = builtin.unrealized_conversion_cast %1 : i64 to index
    %3 = llvm.mlir.constant(120 : index) : i64
  ...
  ^bb4:  // pred: ^bb3
    call @cholesky_kernel_0(%arg0, %5, %9) : (memref<120x120xf32>, index, index) -> ()
    ...
    %20 = llvm.mlir.constant(120 : index) : i64
    ...
    %27 = llvm.mlir.constant(120 : index) : i64
    ...
    cf.br ^bb3(%32 : index)
  ^bb5:  // pred: ^bb3
    call @cholesky_kernel_1(%arg0, %5) : (memref<120x120xf32>, index) -> ()
    %33 = llvm.extractvalue %0[1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %34 = llvm.mlir.constant(120 : index) : i64
    ...
    %41 = llvm.mlir.constant(120 : index) : i64
...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  llvm.func @cholesky(%arg0: !llvm.ptr) {
    ...
    %13 = builtin.unrealized_conversion_cast %12 : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> to memref<120x120xf32>
    %14 = builtin.unrealized_conversion_cast %13 : memref<120x120xf32> to !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>
  ...
  ^bb4:  // pred: ^bb3
    ...
    %44 = llvm.mlir.constant(120 : index) : i64
  ...
  ^bb5:  // pred: ^bb3
    ...
    %52 = llvm.mlir.constant(120 : index) : i64
    ...
    %59 = llvm.mlir.constant(120 : index) : i64
...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  llvm.func @cholesky(%arg0: !llvm.ptr) {
    ...
    %11 = builtin.unrealized_conversion_cast %10 : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> to memref<120x120xf32>
    %12 = builtin.unrealized_conversion_cast %11 : memref<120x120xf32> to !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>
    llvm.br ^bb1(%3 : i64)
