...
cgeist \
    ...
    -DSMALL_DATASET \
    --import-all-index \
    -I/home/jhlou/CGRVOPT/cgra-opt/experiment/Cbenchmarks/Polybench/linear-algebra/kernels/bicg_middle/ \
   ...
   /home/jhlou/CGRVOPT/cgra-opt/experiment/Cbenchmarks/Polybench/linear-algebra/kernels/bicg_middle/bicg.c \
    -S -o bicg.mlir
...
cgra-opt \
    ...
    bicg_normalized.mlir -o bicg_host.mlir
