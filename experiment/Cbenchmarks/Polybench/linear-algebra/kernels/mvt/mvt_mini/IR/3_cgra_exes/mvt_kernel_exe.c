...
void kernel_mvt(void* arg_0 ,void* arg_1 ,void* arg_2 ,void* arg_3 ,void* arg_4){
  ...
  load_data(arg_0 + dramoffset_0 + roffset_0, 0x10000 + spadoffset_0, 160, 0, /*task_id*/0, 0);
  ...
  load_data(arg_4 + dramoffset_1 + roffset_1, 0x18000 + spadoffset_1, 6400, 0, /*task_id*/0, 0);
  ...
  load_data(arg_2 + dramoffset_2 + roffset_2, 0x0 + spadoffset_2, 160, 0, /*task_id*/0, 0);
  ...
  load_cfg((void*)cin, 0x20000, 192, /*task_id*/0, 0);
  config(0x0, 32, /*task_id*/0, 0);
  execute(0x7c04, /*task_id*/0, 0);
  }
  {
  ...
  store(arg_0 + dramoffset_3 + roffset_3, 0x1a000 + spadoffset_3, 160, /*task_id*/1, 0);
  ...
  uint64_t spadoffset_0 = 0;
  uint64_t roffset_0 = 0;
  load_data(arg_1 + dramoffset_0 + roffset_0, 0x18000 + spadoffset_0, 160, 0, /*task_id*/1, 0);
  spadoffset_0 = spadoffset_0 + 160;
  ...
  uint64_t spadoffset_1 = 0;
  uint64_t roffset_1 = 0;
  load_data(arg_4 + dramoffset_1 + roffset_1, 0x10000 + spadoffset_1, 6400, 0, /*task_id*/1, 0);
  spadoffset_1 = spadoffset_1 + 6400;
  ...
  uint64_t spadoffset_2 = 0;
  uint64_t roffset_2 = 0;
  load_data(arg_3 + dramoffset_2 + roffset_2, 0x1a000 + spadoffset_2, 160, 0, /*task_id*/1, 0);
  spadoffset_2 = spadoffset_2 + 160;
  ...
  load_cfg((void*)cin, 0x20000, 168, /*task_id*/1, 0);
  config(0x0, 28, /*task_id*/1, 0);
  execute(0x7c04, /*task_id*/1, 0);
  }
  {
  ...
  uint64_t spadoffset_3 = 0;
  uint64_t roffset_3 = 0;
  store(arg_1 + dramoffset_3 + roffset_3, 0x1c000 + spadoffset_3, 160, /*task_id*/1, 0);
  spadoffset_3 = spadoffset_3 + 160;
