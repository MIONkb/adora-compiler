...
void kernel_3mm(void* arg_0 ,void* arg_1 ,void* arg_2 ,void* arg_3 ,void* arg_4 ,void* arg_5 ,void* arg_6){
  ...
  load_data(arg_1 + dramoffset_0 + roffset_0, 0x18000 + spadoffset_0, 1280, 0, 0, 0);
  ...
  load_data(arg_2 + dramoffset_1 + roffset_1, 0x1a000 + spadoffset_1, 1440, 0, 0, 0);
  ...
  store(arg_0 + dramoffset_2 + roffset_2, 0x1c000 + spadoffset_2, 1152, 0, 0);
  ...
  uint64_t spadoffset_0 = 0;
  uint64_t roffset_0 = 0;
  load_data(arg_4 + dramoffset_0 + roffset_0, 0x0 + spadoffset_0, 1728, 0, 0, 0);
  ...
  uint64_t spadoffset_1 = 0;
  uint64_t roffset_1 = 0;
  load_data(arg_5 + dramoffset_1 + roffset_1, 0x2000 + spadoffset_1, 2112, 0, 0, 0);
  ...
  uint64_t spadoffset_2 = 0;
  uint64_t roffset_2 = 0;
  store(arg_3 + dramoffset_2 + roffset_2, 0x4000 + spadoffset_2, 1584, 0, 0);
  ...
  uint64_t spadoffset_0 = 0;
  uint64_t roffset_0 = 0;
  load_data(arg_0 + dramoffset_0 + roffset_0, 0x0 + spadoffset_0, 1152, 0, 0, 0);
  ...
  uint64_t spadoffset_1 = 0;
  uint64_t roffset_1 = 0;
  load_data(arg_3 + dramoffset_1 + roffset_1, 0x2000 + spadoffset_1, 1584, 0, 0, 0);
  ...
  uint64_t spadoffset_2 = 0;
  uint64_t roffset_2 = 0;
  store(arg_6 + dramoffset_2 + roffset_2, 0x4000 + spadoffset_2, 1408, 0, 0);
