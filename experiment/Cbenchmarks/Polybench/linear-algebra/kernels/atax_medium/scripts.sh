...
cgeist \
    ...
    -DMEDIUM_DATASET \
    --import-all-index \
    -I/home/jhlou/CGRVOPT/cgra-opt/experiment/Cbenchmarks/Polybench/linear-algebra/kernels \
   ...
   /home/jhlou/CGRVOPT/cgra-opt/experiment/Cbenchmarks/Polybench/linear-algebra/kernels/atax/atax.c \
    -S -o atax.mlir
...
cgra-opt \
    ...
    -cse \
    --affine-loop-fusion \
        atax_normalized.mlir -o 1_kernel.mlir
