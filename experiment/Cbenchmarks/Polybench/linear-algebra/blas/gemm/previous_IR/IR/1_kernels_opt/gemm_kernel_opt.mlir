module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @gemm(%arg0: memref<?x25xf32>, %arg1: memref<?x30xf32>, %arg2: memref<?x25xf32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg3 = 0 to 20 {
      ...
      %1 = ADORA.LocalMemAlloc memref<1x25xf32>  {Id = "1", KernelName = "gemm_0+gemm_1"}
      ADORA.kernel {
        affine.for %arg4 = 0 to 25 {
          %5 = affine.load %0[0, %arg4] : memref<1x25xf32>
          %6 = arith.mulf %5, %cst : f32
          affine.store %6, %1[0, %arg4] : memref<1x25xf32>
        }
        ADORA.terminator
      } {KernelName = "gemm_0"}
      ...
      %4 = ADORA.LocalMemAlloc memref<1x25xf32>  {Id = "4", KernelName = "gemm_1"}
      ADORA.kernel {
        affine.for %arg4 = 0 to 25 {
          %5 = affine.load %1[0, %arg4] : memref<1x25xf32>
          %6 = affine.for %arg5 = 0 to 30 iter_args(%arg6 = %5) -> (f32) {
            %7 = affine.load %2[0, %arg5] : memref<1x30xf32>
            %8 = arith.mulf %7, %cst_0 : f32
            %9 = affine.load %3[%arg5, %arg4] : memref<30x25xf32>
            %10 = arith.mulf %8, %9 : f32
            %11 = arith.addf %arg6, %10 : f32
            affine.yield %11 : f32
          }
          affine.store %6, %4[0, %arg4] : memref<1x25xf32>
        }
        ADORA.terminator
      } {KernelName = "gemm_1"}
  ...
  func.func @gemm_opt(%arg0: memref<?x25xf32>, %arg1: memref<?x30xf32>, %arg2: memref<?x25xf32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %1 = ADORA.LocalMemAlloc memref<20x25xf32>  {Id = "1", KernelName = "gemm_opt_0+gemm_opt_1"}
    ADORA.kernel {
      affine.for %arg3 = 0 to 20 {
        affine.for %arg4 = 0 to 25 {
          %5 = affine.load %0[%arg3, %arg4] : memref<20x25xf32>
          %6 = arith.mulf %5, %cst : f32
          affine.store %6, %1[%arg3, %arg4] : memref<20x25xf32>
        }
      }
      ADORA.terminator
    ...
    %4 = ADORA.LocalMemAlloc memref<20x25xf32>  {Id = "4", KernelName = "gemm_opt_1"}
    ADORA.kernel {
      affine.for %arg3 = 0 to 20 {
        affine.for %arg4 = 0 to 30 {
          affine.for %arg5 = 0 to 25 {
            %5 = affine.load %2[%arg3, %arg4] : memref<20x30xf32>
            %6 = arith.mulf %5, %cst_0 : f32
            %7 = affine.load %3[%arg4, %arg5] : memref<30x25xf32>
            %8 = arith.mulf %6, %7 : f32
            %9 = affine.load %1[%arg3, %arg5] : memref<20x25xf32>
            %10 = arith.addf %9, %8 : f32
            affine.store %10, %4[%arg3, %arg5] : memref<20x25xf32>
          }
        }
      }
      ADORA.terminator
