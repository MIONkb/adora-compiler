      ...
      ADORA.kernel {
        affine.for %arg6 = 0 to 5 {
          %5:2 = affine.for %arg7 = 0 to 250 step 2 iter_args(%arg8 = %cst, %arg9 = %cst) -> (f32, f32) {
            ...
            %16 = affine.apply affine_map<(d0) -> (d0 + 1)>(%arg7)
            %17 = affine.load %0[%arg6, %16] : memref<5x250xf32>
            %18 = affine.load %1[%16] : memref<250xf32>
            %19 = arith.mulf %17, %18 : f32
            %20 = arith.addf %19, %12 : f32
            %21 = affine.load %2[%arg6, %16] : memref<5x250xf32>
            %22 = arith.mulf %21, %18 : f32
            %23 = arith.addf %22, %15 : f32
            affine.yield %20, %23 : f32, f32
          }
