...
DATASET_Size="MINI_DATASET"
gcc \
 -DMINI_DATASET -DDATA_TYPE_IS_FLOAT \
 -Wl,--wrap,malloc \
 -DPREALLOCATE=1 -DMULTITHREAD=1  \
 -O2 -ffast-math -fno-common \
 -fno-tree-loop-distribute-patterns \
 -I/home/jhlou/CGRVOPT/cgra-opt/experiment/Cbenchmarks/Polybench/utilities \
 -lm \
 -o gemm_local \
 /home/jhlou/CGRVOPT/cgra-opt/experiment/Cbenchmarks/Polybench/linear-algebra/blas/gemm_local/gemm_main.c


./gemm_local > result.log