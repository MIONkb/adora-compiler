...
inline void local_scan(int bucket[BUCKETSIZE])
{
    #pragma scop
...
inline void sum_scan(int sum[SCAN_RADIX], int bucket[BUCKETSIZE])
{
    #pragma scop
...
inline void last_step_scan(int bucket[BUCKETSIZE], int sum[SCAN_RADIX])
{
    #pragma scop
    int radixID, i, bucket_indx;
...
inline void init(int bucket[BUCKETSIZE])
{
    #pragma scop
    int i;
...
inline  void hist(int bucket[BUCKETSIZE], int a[SIZE], int exp)
{
    #pragma scop
...
inline void update(int b[SIZE], int bucket[BUCKETSIZE], int a[SIZE], int exp)
{
    #pragma scop
