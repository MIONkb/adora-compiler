    ...
    ADORA.kernel {
      affine.for %arg1 = 0 to 128 {
        affine.for %arg2 = 0 to 15 {
          %0 = affine.load %arg0[%arg1 * 16 + %arg2] : memref<?xi32>
          %1 = affine.load %arg0[%arg1 * 16 + %arg2 + 1] : memref<?xi32>
          %2 = arith.addi %1, %0 : i32
          affine.store %2, %arg0[%arg1 * 16 + %arg2 + 1] : memref<?xi32>
        }
      }
      ADORA.terminator
  ...
  func.func @sum_scan(%arg0: memref<?xi32>, %arg1: memref<?xi32>) attributes {llvm.linkage = #llvm.linkage<available_externally>} {
    ...
    ADORA.kernel {
      affine.for %arg2 = 0 to 127 {
        ...
        %1 = affine.load %arg1[%arg2 * 16 + 15] : memref<?xi32>
        %2 = arith.addi %0, %1 : i32
        affine.store %2, %arg0[%arg2 + 1] : memref<?xi32>
      }
      ADORA.terminator
    } {KernelName = "sum_scan"}
    return
