module attributes {torch.debug_module_name = "Softmax"} {
  ...
  func.func @forward(%arg0: memref<1x128x64xf32>, %arg1: memref<1x128x1xf32>, %arg2: memref<1x128x1xi64>, %arg3: memref<1x128x64xf32>, %arg4: memref<1x128x64xf32>, %arg5: memref<1x128x1xf32>, %arg6: memref<1x128x1xf32>, %arg7: memref<1x128x64xf32>) {
    ...
    call @forward_kernel_2(%arg3, %arg4) : (memref<1x128x64xf32>, memref<1x128x64xf32>) -> ()
    call @forward_kernel_3(%arg4, %arg6) : (memref<1x128x64xf32>, memref<1x128x1xf32>) -> ()
    call @forward_kernel_4(%arg4, %arg6, %arg7) : (memref<1x128x64xf32>, memref<1x128x1xf32>, memref<1x128x64xf32>) -> ()
    return
  }
  ...
  func.func private @forward_kernel_2(memref<1x128x64xf32>, memref<1x128x64xf32>)
  func.func private @forward_kernel_3(memref<1x128x64xf32>, memref<1x128x1xf32>)
  func.func private @forward_kernel_4(memref<1x128x64xf32>, memref<1x128x1xf32>, memref<1x128x64xf32>)
}
