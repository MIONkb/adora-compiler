module attributes {torch.debug_module_name = "Softmax"} {
  ...
  func.func @forward( %arg0: memref<1x128x64xf32>, 
                      %alloc_2: memref<1x128x1xf32>, 
                      %alloc_3: memref<1x128x1xi64>,
                      %alloc_4: memref<1x128x64xf32>,
                      %alloc_5: memref<1x128x64xf32>,
                      %alloc_6: memref<1x128x1xf32>,
                      %alloc_7: memref<1x128x1xf32>,
                      %alloc_8: memref<1x128x64xf32>              
                      ) {
