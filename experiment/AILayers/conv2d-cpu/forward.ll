...
@__constant_6xf32 = private constant [6 x float] [float 0xBFB14B2CC0000000, float 0xBFB4220720000000, float 0xBFB39301C0000000, float 0xBF62CA7640000000, float 0xBFB4768F40000000, float 0xBFB2E2B540000000]
...
define ptr @forward(ptr %0) {
  %2 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 20184) to i64), i64 64))
...
16:                                               ; preds = %34, %15
  %17 = phi i64 [ %35, %34 ], [ 0, %15 ]
  %18 = icmp slt i64 %17, 58
...
20:                                               ; preds = %23, %19
  ...
  %22 = icmp slt i64 %21, 58
  br i1 %22, label %23, label %34

23:                                               ; preds = %20
  %24 = getelementptr float, ptr @__constant_6xf32, i64 %13
  ...
  %30 = add i64 %28, %29
  %31 = add i64 %30, %21
  %32 = getelementptr float, ptr %7, i64 %31
...
49:                                               ; preds = %104, %48
  %50 = phi i64 [ %105, %104 ], [ 0, %48 ]
  %51 = icmp slt i64 %50, 58
...
53:                                               ; preds = %102, %52
  %54 = phi i64 [ %103, %102 ], [ 0, %52 ]
  %55 = icmp slt i64 %54, 58
...
68:                                               ; preds = %65
  ...
  %75 = add i64 %73, %74
  %76 = add i64 %75, %70
  %77 = getelementptr float, ptr %0, i64 %76
  ...
  %83 = add i64 %81, %82
  %84 = add i64 %83, %66
  %85 = getelementptr float, ptr @__constant_6x3x7x7xf32, i64 %84
  ...
  %91 = add i64 %89, %90
  %92 = add i64 %91, %54
  %93 = getelementptr float, ptr %7, i64 %92
