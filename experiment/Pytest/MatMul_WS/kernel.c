...
void merge_MATMUL_4x4_IS(int a[W][N], int b[N][H], int c[W][H]) {
    #pragma scop
    // int cc[4];
    for(int j=0 ; j<H/4 ; j++){
        // for(int k=0 ; k<H/4 ; ++k) {
...
// void merge_MATMUL_4x4_OS(int a[W][N], int b[N][H], int c[W][H]) {
//     #pragma scop
//     for ( int i=0 ; i<W/4 ; i++ ) {
//         for(int j=0 ; j<H/4 ; j++ ){
//             c[4*i][4*j+0]   = 0;
