      ...
      affine.for %arg3 = 0 to 36 {
        affine.for %arg4 = 0 to 36 {
          affine.for %arg5 = 0 to 9 {
            ...
            %5 = affine.load %arg0[%arg5 + 1, %arg4] : memref<?x36xi32>
            %6 = arith.muli %5, %1 : i32
            %7 = affine.load %arg2[%arg5 + 1, %arg3] : memref<?x36xi32>
            %8 = arith.addi %7, %6 : i32
            affine.store %8, %arg2[%arg5 + 1, %arg3] : memref<?x36xi32>
            %9 = affine.load %arg0[%arg5 + 2, %arg4] : memref<?x36xi32>
            %10 = arith.muli %9, %1 : i32
            %11 = affine.load %arg2[%arg5 + 2, %arg3] : memref<?x36xi32>
            %12 = arith.addi %11, %10 : i32
            affine.store %12, %arg2[%arg5 + 2, %arg3] : memref<?x36xi32>
            %13 = affine.load %arg0[%arg5 + 3, %arg4] : memref<?x36xi32>
