//===- Passes.h - ADORA-opt pass entry points --------------------*- C++ -*-===//
//
...
#ifndef ADORA_MISC_PASSES_H
#define ADORA_MISC_PASSES_H
...
#include "ADORA/Misc/ADORAMiscPasses.h.inc"
