  ...
  func.func @gemm(%arg0: f32, %arg1: f32, %arg2: memref<?x25xf32>, %arg3: memref<?x30xf32>, %arg4: memref<?x25xf32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    affine.for %arg5 = 0 to 20 {
      affine.for %arg6 = 0 to 25 {
        %0 = affine.load %arg2[%arg5, %arg6] : memref<?x25xf32>
        %1 = arith.mulf %0, %arg1 : f32
        affine.store %1, %arg2[%arg5, %arg6] : memref<?x25xf32>
      }
      affine.for %arg6 = 0 to 30 {
        affine.for %arg7 = 0 to 25 {
          %0 = affine.load %arg3[%arg5, %arg6] : memref<?x30xf32>
          %1 = arith.mulf %arg0, %0 : f32
          %2 = affine.load %arg4[%arg6, %arg7] : memref<?x25xf32>
          %3 = arith.mulf %1, %2 : f32
          %4 = affine.load %arg2[%arg5, %arg7] : memref<?x25xf32>
          %5 = arith.addf %4, %3 : f32
          affine.store %5, %arg2[%arg5, %arg7] : memref<?x25xf32>
        }
      }
    }
    return
